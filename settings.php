...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($_POST["username"])){
            $usernameErr = "Pla enter a new username";
        }else{
        ...
        if(empty($_POST["password"])){
            $passwordErr = "Pls enter a new password";
        }else{
...
<div class="sidebar">
    ...
    <div class="tasks">
        ...
        <div class="set">
                 <div class="profile">
                    <img class="pfpr" src="assets/uploads/<?php echo htmlspecialchars($user["pfp"]); ?>" alt="profile-picture">
                    <h3 class="name"><?php echo $user["username"]; ?></h3>
                    <p class="gmail">sarlaksaleh7@gmail.com</p>
                </div>

        <form method="POST" class="sform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">

            <div class="forms">
                <div class="inps">
                    <label for="title">Username</label>
                    <input class="inputs" name="username" type="text" placeholder="Ex. Wliliam" >
            ...
            <div class="btnss">
                            ...
                            <button class="btnns addbtnn" type="submit">Edit</button>
                            <button id="cancbtn"  type="button"  class="btnns">Cancel</button>
